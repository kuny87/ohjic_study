...
public class FaqController {
	...
	@RequestMapping(value = "/board_faq_list", method = RequestMethod.GET)
	public ModelAndView boardList(
			@ModelAttribute BoardSearch boardSearch,
			@ModelAttribute("user") User user) {
		
		ModelAndView mav = new ModelAndView("board/faq/list");
		
		boardSearch.setType(EBoardType.FAQ);
	...
	@RequestMapping(value = "/board_faq_get", method = RequestMethod.GET)
	public ModelAndView boardSelectOne(
			@ModelAttribute Board board,
			@ModelAttribute BoardSearch boardSearch,
			@ModelAttribute("user") User user) {
		
		ModelAndView mav = new ModelAndView("board/faq/get");
	...
	@RequestMapping(value = "/board_faq_regist", method = RequestMethod.GET)
	public ModelAndView boardRegist(
			@ModelAttribute("user") User user) {
		
		ModelAndView mav = new ModelAndView("board/faq/regist");
