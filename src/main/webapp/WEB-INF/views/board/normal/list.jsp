...
<div class="right" style="width: 80%">
	${user.name} 님 <button onclick="javascript:logout()">로그아웃</button>	
</div>
...
<script>
	...
	// 글쓰기
	function regist() {
		location.href = '/test_ohjic/board_normal_regist';
	}
	
	// 글확인
	function get(boardSeq) {
		if(startDate != '' && endDate != ''){
			location.href = '/test_ohjic/board_normal_get?startDate=' + startDate + '&endDate=' + endDate + '&searchType=' + searchType + '&keyword=' + keyword + '&boardSize=' + boardSize + '&boardSeq=' + boardSeq + '&pageNo=' + pageNo;
		}else {
			location.href = '/test_ohjic/board_normal_get?searchType=' + searchType + '&keyword=' + keyword + '&boardSize=' + boardSize + '&boardSeq=' + boardSeq + '&pageNo=' + pageNo;	
		}
		/* location.href = '/test_ohjic/board_get?boardSeq=' + boardSeq; */
	}
	...
	function search() {
		...
		if(startDate != '' && endDate != ''){
			location.href = '/test_ohjic/board_normal_list?startDate=' + startDate + '&endDate=' + endDate + '&searchType=' + searchType + '&keyword=' + keyword + '&boardSize=' + boardSize + '&pageNo=1';
		}else {
			location.href = '/test_ohjic/board_normal_list?searchType=' + searchType + '&keyword=' + keyword + '&boardSize=' + boardSize + '&pageNo=1';	
		}
	}
